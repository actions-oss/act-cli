...
# (godownloader is deprecated, so changes to this script are maintained in install.sh in https://github.com/actions-oss/act-cli)
#
...
Usage: $this [-b bindir] [-d] [-f] [tag]
  ...
  -f forces installation, bypassing version checks
   [tag] is a tag from
   https://github.com/actions-oss/act-cli/releases
